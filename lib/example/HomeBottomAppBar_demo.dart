...
class HomeBottomAppBarDemo extends StatefulWidget{

  @override
  _HomeBottomAppBarDemoState createState() => _HomeBottomAppBarDemoState();

}

class _HomeBottomAppBarDemoState extends State<HomeBottomAppBarDemo> {
